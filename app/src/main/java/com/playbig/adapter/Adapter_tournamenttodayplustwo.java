 ...
 */
public class Adapter_tournamenttodayplustwo extends  RecyclerView.Adapter<Adapter_tournamenttodayplustwo.ViewHolder> {
    ...
    public Adapter_tournamenttodayplustwo(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_tournamenttodayplustwo.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tournamenttodayplustwo, null);
