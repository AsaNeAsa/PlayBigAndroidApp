 ...
 */
public class Adapter_ranking_tournamentfriend extends   RecyclerView.Adapter<Adapter_ranking_tournamentfriend.ViewHolder> {
...
private ItemData[] itemsData;
    ...
    public Adapter_ranking_tournamentfriend(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_ranking_tournamentfriend.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tournamentfriendranking, null);
