 ...
 */
 public class Adapter_quickabettodayplusone extends RecyclerView.Adapter<Adapter_quickabettodayplusone.ViewHolder> {
    ...
    public Adapter_quickabettodayplusone(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_quickabettodayplusone.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quickbettoday, null);
