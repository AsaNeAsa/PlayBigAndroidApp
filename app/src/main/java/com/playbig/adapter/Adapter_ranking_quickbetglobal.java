 ...
 */
public class Adapter_ranking_quickbetglobal extends RecyclerView.Adapter<Adapter_ranking_quickbetglobal.ViewHolder>  {
    ...
    public Adapter_ranking_quickbetglobal(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_ranking_quickbetglobal.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quickbetglobalranking, null);
