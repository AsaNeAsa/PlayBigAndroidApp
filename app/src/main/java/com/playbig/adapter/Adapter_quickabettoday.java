 ...
 */
 public class Adapter_quickabettoday extends RecyclerView.Adapter<Adapter_quickabettoday.ViewHolder> {
    ...
    public Adapter_quickabettoday(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_quickabettoday.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
