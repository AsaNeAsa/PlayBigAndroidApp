 ...
 */
public class Adapter_ranking_quickbetfriend  extends RecyclerView.Adapter<Adapter_ranking_quickbetfriend.ViewHolder>{
    ...
    public Adapter_ranking_quickbetfriend(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_ranking_quickbetfriend.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quickbetfriendranking, null);
