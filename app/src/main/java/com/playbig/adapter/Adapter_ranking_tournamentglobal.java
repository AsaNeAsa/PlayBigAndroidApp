 ...
 */
  public class Adapter_ranking_tournamentglobal  extends RecyclerView.Adapter<Adapter_ranking_tournamentglobal.ViewHolder> {
    ...
    public Adapter_ranking_tournamentglobal(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_ranking_tournamentglobal.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tournamentglobalranking, null);
