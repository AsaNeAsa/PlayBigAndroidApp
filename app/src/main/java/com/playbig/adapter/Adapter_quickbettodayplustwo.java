 ...
 */
public class Adapter_quickbettodayplustwo  extends RecyclerView.Adapter<Adapter_quickbettodayplustwo.ViewHolder> {
    ...
    public Adapter_quickbettodayplustwo(ItemData[] itemsData, Context ctxt) {
    ...
    public Adapter_quickbettodayplustwo.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quickbettodayplustwo, null);
