 ...
 */
public class Activity_quickranking extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quickbetranking);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_quickbetFriendranking(), "Friend");
        adapter.addFragment(new Fragment_quickbetGlobalranking(), "Global");
