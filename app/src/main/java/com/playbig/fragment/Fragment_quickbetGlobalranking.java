...
import com.playbig.adapter.Adapter_ranking_quickbetglobal;
 ...
 */
public class Fragment_quickbetGlobalranking extends BaseFragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_quickbetglobalranking, container, false);
        init(view);
        return view;
    }
    ...
    protected void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.ranking_quickbetglobal);
        ...
        Adapter_ranking_quickbetglobal adp_tournament = new Adapter_ranking_quickbetglobal(itemsData, mActivity);
