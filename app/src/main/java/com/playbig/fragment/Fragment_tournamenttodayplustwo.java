...
import com.playbig.adapter.Adapter_quickabettoday;
import com.playbig.adapter.Adapter_tournamenttodayplustwo;
 ...
 */
public class Fragment_tournamenttodayplustwo extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tournamenttodayplustwo, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.tournament_todayplustwo);
        ...
        Adapter_tournamenttodayplustwo adp_touranamenttodayplusone = new Adapter_tournamenttodayplustwo(itemsData,mActivity);
        recyclerView.setAdapter(adp_touranamenttodayplusone);
