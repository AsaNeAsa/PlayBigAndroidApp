...
import com.playbig.adapter.Adapter_quickbettodayplustwo;
 ...
 */
public class Fragment_quickbettodayplustwo extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_quickbettodayplustwo, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.quickbet_todayplustwo);
        ...
        Adapter_quickbettodayplustwo adp_quickplacebettodayplustwo = new Adapter_quickbettodayplustwo(itemsData,mActivity);
        recyclerView.setAdapter(adp_quickplacebettodayplustwo);
