 ...
 */
public class Fragment_quickbettoday extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_quickbettoday, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.quickbet_today);
        ...
        Adapter_quickabettoday adp_quickplacebettoday = new Adapter_quickabettoday(itemsData,mActivity);
        recyclerView.setAdapter(adp_quickplacebettoday);
