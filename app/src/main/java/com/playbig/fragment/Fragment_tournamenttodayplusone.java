 ...
 */
public class Fragment_tournamenttodayplusone extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tournamenttodyplusone, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.tournament_todayplusone);
        ...
        Adapter_tournamenttodayplusone adp_touranamenttodayplusone = new Adapter_tournamenttodayplusone(itemsData,mActivity);
