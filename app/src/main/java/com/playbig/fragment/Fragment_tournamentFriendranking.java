...
import com.playbig.adapter.Adapter_ranking_tournamentfriend;
 ...
 */
public class Fragment_tournamentFriendranking extends BaseFragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tournamentfriendranking, container, false);
        init(view);
        return view;
    }
    ...
    protected void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.ranking_tournamentfriend);
        ...
        Adapter_ranking_tournamentfriend adp_tournament = new Adapter_ranking_tournamentfriend(itemsData, mActivity);
