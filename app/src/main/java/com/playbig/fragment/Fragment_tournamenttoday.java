...
import com.playbig.adapter.Adapter_tournamenttoday;
 ...
 */
public class Fragment_tournamenttoday extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tournamenttoday, container, false);
        init(view);
        return view;
    }
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.tournament_today);
        ...
        Adapter_tournamenttoday adp_tournamenttoday = new Adapter_tournamenttoday(itemsData,mActivity);
        recyclerView.setAdapter(adp_tournamenttoday);
